...
/**
 * Created by harishananth on 12/12/16.
 */

public class Roadwise extends AppCompatActivity {
    private RelativeLayout activity_main;
    private PieChart mChart;
    //display pie chart
    private float[] yData={5,10,15,21,49};
    private String[] xData={"TTk Road","Sterling Road","Haddows Road","Mount Road","East Coast Road"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart.setDescription("Real Time Road wise Accident Analytics");
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                Toast.makeText(Roadwise.this,xData[e.getXIndex()] +"=" + e.getVal() +"%" ,Toast.LENGTH_SHORT).show();
