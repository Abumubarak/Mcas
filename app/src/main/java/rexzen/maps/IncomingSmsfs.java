...
public class IncomingSmsfs extends BroadcastReceiver {
                ...
                if (bundle != null) {
                    ...
                    for (int i = 0; i < pdusObj.length; i++) {
...

                        {
                            ...
                            //mp.start();
                            if(message.contains("firstsen"))
                            {
                                firstsen=message.replaceAll("firstsen","");
                                Toast.makeText(context,firstsen+" Sensor activated",Toast.LENGTH_SHORT).show();
